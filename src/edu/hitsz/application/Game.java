...
public class Game extends JPanel {
    ...
    public void addOtherPlayer(OtherPlayer otherPlayer) {
        playerAircrafts.add(otherPlayer);
        clientWorldState.getPlayerAircrafts().add(otherPlayer);
    }
        ...
        for (BaseBullet bullet : heroBullets) {
            ...
            for (AbstractAircraft enemyAircraft : enemyAircrafts) {
                ...
                if (enemyAircraft.crash(bullet)) {
                    ...
                    bullet.vanish();
                    if (enemyAircraft.notValid()) {
                        score += enemyAircraft instanceof EliteEnemy ? 20 : 10;
