...
public final class GameplayBalance {
    ...
    // =========================
    /** 玩家初始生命值。 */
    public static final int PLAYER_INITIAL_HP = 2000;
    /** 玩家初始单次发射弹数。 */
    public static final int PLAYER_BASE_SHOOT_NUM = 1;
    /** 玩家最大基础弹数上限。 */
    public static final int PLAYER_MAX_SHOOT_NUM = 5;
    /** 玩家基础射击周期。数值越小，射速越高。 */
    public static final int PLAYER_BASE_SHOOT_CYCLE = 25;
    /** 玩家射击周期下限，防止成长后无限提速。 */
    ...
    /** 玩家子弹伤害上限。 */
    public static final int PLAYER_MAX_BULLET_POWER = 100;
    /** 每次火力成长增加的基础子弹伤害。 */
    public static final int PLAYER_BULLET_POWER_STEP = 15;
    /** 玩家普通子弹速度。 */
    public static final int PLAYER_BULLET_SPEED = 8;
    /** 射速升级每级减少多少发射周期。 */
    public static final int PLAYER_FIRE_RATE_UPGRADE_CYCLE_REDUCTION = 2;
    /** 子弹伤害升级每级增加的伤害。 */
    public static final int PLAYER_BULLET_POWER_UPGRADE_BONUS = 15;
    /** 散射升级每级增加的额外弹数。 */
    ...
    /** 红色速度机“移速强化”每级增加的移速。 */
    public static final int RED_SPEED_MOVE_SPEED_UPGRADE_BONUS = 3;
    ...
    public static final int RED_SPEED_LASER_DURATION_UPGRADE_BONUS = 2;
    ...
    /** 通用生命上限强化，每级增加的最大生命值。 */
    public static final int BRANCH_MAX_HP_UPGRADE_BONUS = 320;
    ...
    // =========================
    /** 第 2 章精英横向散射间隔。 */
    public static final int CH2_ELITE_SPREAD_X_SPEED_STEP = 8;
    /** 第 2 章 Boss 横向散射间隔。 */
    public static final int CH2_BOSS_SPREAD_X_SPEED_STEP = 6;
    /** 第 3 章精英横向散射间隔。 */
    public static final int CH3_ELITE_SPREAD_X_SPEED_STEP = 7;
    /** 第 3 章 Boss 横向散射间隔。 */
    public static final int CH3_BOSS_SPREAD_X_SPEED_STEP = 5;
    ...
    // =========================
    /** 每多少分升 1 级。 */
    public static final int SCORE_PER_LEVEL = 280;
    /** 玩家等级上限。 */
